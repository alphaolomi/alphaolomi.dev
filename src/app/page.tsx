    ...
    <>
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          I’m Alpha, a software engineer and open source enthusiast based in Tanzania. Building <span className='underline'>Openpesa</span>, where we develop technologies that facilitate payments systems and integrations
          </p>
          <div className="flex gap-6 mt-6">
            <SocialLink  href="https://twitter.com/alphaolomi"
